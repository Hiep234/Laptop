...
config_mod.DB_URI = os.environ["DB_URI"]; config_mod.OPENROUTER_API_KEY = os.environ["OPENROUTER_API_KEY"]
config_mod.OPENROUTER_MODEL = os.environ["OPENROUTER_MODEL"]; config_mod.TOP_K = 5; config_mod.CANDIDATE_LIMIT = 500
...
# Mock requests.post for OpenRouter API
import requests
class MockResponse:
...
requests.post = lambda url, **k: MockResponse({"choices": [{"message": {"content": "mock"}}]})
...
from openrouter_service import SYSTEM_PROMPT
