...
def _llm_classify_intent(text: str, has_context: bool) -> str:
    """Dùng OpenRouter phân loại intent cho trường hợp mơ hồ."""
    from openrouter_service import call_openrouter
    try:
        ...
        messages = [
            {"role": "system", "content": "Bạn là bộ phân loại ý định. Trả lời CHỈ bằng MỘT từ duy nhất."},
            {"role": "user", "content": prompt}
        ]
        response_text = call_openrouter(messages, temperature=0.0, max_tokens=20)
